...
describe('User', function() {
  ...
  describe('saveRecipe', function() {
    ...
    it('should not add to the favoriteRecipes array if a recipe is undefined', function() {
  ...
  describe('removeRecipe', function() {
  ...
  describe('decideToCook', function() {
    ...
    it('should not add to the recipesToCook array if the recipe is undefined', function() {
  ...
  describe('filterRecipes', function() {
    ...
    it('should return null if the type is undefined in the filterRecipes function when looking in recipes to cook', function() {
      let recipe1 = {name: 'strawberry shortcake biscuit', type: undefined};
      user1.saveRecipe(recipe1);
      expect(user1.filterRecipes(undefined, user1.recipesToCook)).to.equal(null)
      });
  });

  describe('searchForRecipe', function() {
  ...
  describe('determineIngredientsAvailable', function() {
